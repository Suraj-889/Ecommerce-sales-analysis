...
## 2) Install the required libraries: pip install pandas plotly jupyter
## 3) Run the analysis: open the primary analysis notebook(e.g. file.ipynb) in Jupyter and execute the cells.
